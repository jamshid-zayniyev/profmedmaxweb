        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-[#2D1B69] text-4xl lg:text-5xl font-bold mb-6 leading-tight">
              Премиальное лечение<br />для здорового образа жизни
            </h1>
            
            <p className="text-[#718096] text-lg mb-8 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Комплексный подход к вашему здоровью с использованием передовых технологий и индивидуального подхода к каждому пациенту.
            </p>
