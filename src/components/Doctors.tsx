...
export function Doctors() {
  ...
  const isValidImage = (imagePath: string | null): boolean => {
    ...
    if (imagePath.startsWith('/media/') || imagePath.startsWith('/static/') || imagePath.startsWith('/uploads/')) {
      return false;
    }
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {doctors.map((doctor, index) => {
            ...
            return (
              <Card key={doctor.id} className="border-0 shadow-lg overflow-hidden rounded-2xl hover:shadow-2xl transition-all">
                {/* Image Section */}
                ...
                <div className="relative bg-[#231864] p-6 text-white">
                  ...
                  <div className={`inline-block px-3 py-1 rounded-full mb-3 bg-gradient-to-r ${getDoctorColor(index)} text-white text-sm font-semibold`}>
